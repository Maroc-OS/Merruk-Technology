...
/** defines **/
#define __TOUCH_DEBUG__  //TODO : 辞獄拭 臣軒澗 井酔拭澗 厳壱 臣軒奄.
#define USE_THREADED_IRQ 1 //TODO : QUEUE 号縦戚 焼観 THREAD 号縦生稽 痕井. 戚係惟 馬艦, IRQ 亜 舛雌旋生稽 設喫.
#define DELAY_BEFORE_VDD
#ifdef CONFIG_TOUCHSCREEN_TMA340_COOPERVE //CooperVE
#define SET_DOWNLOAD_BY_GPIO 0 //TODO : TSP 段奄鉢 欠鴇拭辞 悪薦稽 置重 FW 稽 穣汽戚闘 馬澗 欠鴇生稽 紫遂馬檎 照喫.
#define LATEST_FW_VER   0x03 //TODO : 戚採歳聖 0x0 生稽 馬檎, SET_DOWNLOAD_BY_GPIO 1 戚嬢亀 疑拙馬走 照敗.
#define FORCED_DOWNLOAD_OF_BLANKMEMORY	// TSP blank memory( No firmware ) 雌殿獣 切疑 鈍裾嬢 陥錘稽球
#endif
...
static int melfas_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	i2c_release_client(client);	
       //touch_ctrl_regulator_mms128(TOUCH_OFF); //Melfas 拭辞 TOUCH_OFF 馬檎, Cypress 稽 OFF 吉陥.
	kfree(ts);
