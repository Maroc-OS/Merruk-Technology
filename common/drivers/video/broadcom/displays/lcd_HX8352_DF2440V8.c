...
*
*	@file	drivers/char/bcm116x/lcd_HX8352_DF2440V8.c
*
...
/****************************************************************************
*
*  lcd_HX8352_DF2440V8.c
*
*  PURPOSE:
*    This is the LCD-specific code for a Wintek DF2440V8 with HX8352-B00
*    controller.
*
*****************************************************************************/
...
const char *LCD_panel_name = "Wintek WQVGA  HX8352_DF2440V8";
...
/* commands/command data must be in bits 8:1). Using parallel type II 18 bit intf. */
#define LCD_OUT(data) (((u32)(data)&0x000000ff)<<1)
...
static Init_Seq_t Init_Seq[] = {
	...
	{WRITE_INDEX, LCD_OUT(0x0024)}, {WRITE_DATA, LCD_OUT(0x00C0)},	/* VMH */
	{WRITE_INDEX, LCD_OUT(0x0025)}, {WRITE_DATA, LCD_OUT(0x0085)},	/* VML */

	{WRITE_INDEX, LCD_OUT(0x002F)}, {WRITE_DATA, LCD_OUT(0x0001)},	/* inversion mode */

	{WRITE_INDEX, LCD_OUT(0x001B)}, {WRITE_DATA, LCD_OUT(0x0032)},	/* Power control */
	{WRITE_INDEX, LCD_OUT(0x001C)}, {WRITE_DATA, LCD_OUT(0x0003)},	/* Power control */
	{WRITE_INDEX, LCD_OUT(0x0019)}, {WRITE_DATA, LCD_OUT(0x0001)},
	{WRITE_PAUSE, 10},	/* delay 10ms */
	{WRITE_INDEX, LCD_OUT(0x001F)}, {WRITE_DATA, LCD_OUT(0x0090)},	/* Power control */
	{WRITE_PAUSE, 10},	/* delay 10ms */
	{WRITE_INDEX, LCD_OUT(0x001F)}, {WRITE_DATA, LCD_OUT(0x00D2)},	/* exit standby mode */
	{WRITE_PAUSE, 10},	/* delay 10ms */

	{WRITE_INDEX, LCD_OUT(0x0040)}, {WRITE_DATA, LCD_OUT(0x0000)},	/* gamma setting */
	{WRITE_INDEX, LCD_OUT(0x0041)}, {WRITE_DATA, LCD_OUT(0x0033)},
	{WRITE_INDEX, LCD_OUT(0x0042)}, {WRITE_DATA, LCD_OUT(0x0031)},
	{WRITE_INDEX, LCD_OUT(0x0043)}, {WRITE_DATA, LCD_OUT(0x003E)},
	{WRITE_INDEX, LCD_OUT(0x0044)}, {WRITE_DATA, LCD_OUT(0x003D)},
	{WRITE_INDEX, LCD_OUT(0x0045)}, {WRITE_DATA, LCD_OUT(0x003F)},
	{WRITE_INDEX, LCD_OUT(0x0046)}, {WRITE_DATA, LCD_OUT(0x0036)},
	{WRITE_INDEX, LCD_OUT(0x0047)}, {WRITE_DATA, LCD_OUT(0x007A)},
	{WRITE_INDEX, LCD_OUT(0x0048)}, {WRITE_DATA, LCD_OUT(0x000A)},
	{WRITE_INDEX, LCD_OUT(0x0049)}, {WRITE_DATA, LCD_OUT(0x0004)},
	{WRITE_INDEX, LCD_OUT(0x004A)}, {WRITE_DATA, LCD_OUT(0x0005)},
	{WRITE_INDEX, LCD_OUT(0x004B)}, {WRITE_DATA, LCD_OUT(0x000B)},
	{WRITE_INDEX, LCD_OUT(0x004C)}, {WRITE_DATA, LCD_OUT(0x0017)},

	{WRITE_INDEX, LCD_OUT(0x0050)}, {WRITE_DATA, LCD_OUT(0x0000)},
	{WRITE_INDEX, LCD_OUT(0x0051)}, {WRITE_DATA, LCD_OUT(0x0002)},
	{WRITE_INDEX, LCD_OUT(0x0052)}, {WRITE_DATA, LCD_OUT(0x0001)},
	{WRITE_INDEX, LCD_OUT(0x0053)}, {WRITE_DATA, LCD_OUT(0x000C)},
	{WRITE_INDEX, LCD_OUT(0x0054)}, {WRITE_DATA, LCD_OUT(0x000E)},
	{WRITE_INDEX, LCD_OUT(0x0055)}, {WRITE_DATA, LCD_OUT(0x003F)},
	{WRITE_INDEX, LCD_OUT(0x0056)}, {WRITE_DATA, LCD_OUT(0x0005)},
	{WRITE_INDEX, LCD_OUT(0x0057)}, {WRITE_DATA, LCD_OUT(0x0049)},
	{WRITE_INDEX, LCD_OUT(0x0058)}, {WRITE_DATA, LCD_OUT(0x0008)},
	{WRITE_INDEX, LCD_OUT(0x0059)}, {WRITE_DATA, LCD_OUT(0x0014)},
	{WRITE_INDEX, LCD_OUT(0x005A)}, {WRITE_DATA, LCD_OUT(0x001A)},
	{WRITE_INDEX, LCD_OUT(0x005B)}, {WRITE_DATA, LCD_OUT(0x001B)},
	{WRITE_INDEX, LCD_OUT(0x005C)}, {WRITE_DATA, LCD_OUT(0x0015)},
	{WRITE_INDEX, LCD_OUT(0x005D)}, {WRITE_DATA, LCD_OUT(0x00FF)},

	{WRITE_INDEX, LCD_OUT(0x0028)}, {WRITE_DATA, LCD_OUT(0x0020)},
	{WRITE_PAUSE, 40},	/* delay 40ms */
	{WRITE_INDEX, LCD_OUT(0x0028)}, {WRITE_DATA, LCD_OUT(0x0038)},
	{WRITE_PAUSE, 40},	/* delay 40ms */
	{WRITE_INDEX, LCD_OUT(0x0028)}, {WRITE_DATA, LCD_OUT(0x003C)},
	{WRITE_PAUSE, 20},	/* delay 20ms */
