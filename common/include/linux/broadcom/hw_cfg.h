...
/* GPIO Assignments - pins not showing up here are
 * either preallocated (e.g. keyboard 0-3, 8-14),
 * or used by the hardware internally (e.g. BT, codec),
 * or are unassigned (e.g. 31).
 */
