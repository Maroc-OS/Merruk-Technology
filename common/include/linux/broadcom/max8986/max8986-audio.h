...
/* Max8986 mixer selection - hs or spk */
enum {
...
extern int max8986_set_hs_preamp_gain(int gain);
extern int max8986_set_ihf_preamp_gain(int gain);
extern int max8986_audio_enable_zcd(int enable);
extern int max8986_audio_enable_vol_slew(int enable);
