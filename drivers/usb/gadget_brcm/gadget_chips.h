...
#ifdef CONFIG_USB_GADGET_BCM1160
#define gadget_is_bcm1160(g) !strcmp("bcm1160_udc", (g)->name)
#else
#define gadget_is_bcm1160(g) 0
#endif
...
#define gadget_is_bcm28xx_2(g)   !strcmp("bcm28xx_udc2", (g)->name)
#else
#define gadget_is_bcm28xx_2(g)   0
#endif
