...
#ifndef _BCM_KPDP_DEBUG_H
#define _BCM_KPDP_DEBUG_H
#include "bcmlog.h"
...
#define KPDP_DEBUG(level,fmt,args...) do { if (level & logLevel) printk( "%s:: " fmt, __FUNCTION__, ##args ); } while (0)
//#define KPDP_DEBUG(level,fmt,args...)

static int logLevel = DBG_DEFAULT_LEVEL;

#endif //_BCM_KPDP_DEBUG_H
