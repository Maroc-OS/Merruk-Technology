...
bool_t     xdr_CcCnapName_t(XDR *, CcCnapName_t *);
...
bool_t 	xdr_CcCipherInd_t(XDR* , CcCipherInd_t *);
bool_t 	xdr_SS_UserInfo_t(XDR *, SS_UserInfo_t *);
bool_t	xdr_CC_FacilityInd_t(XDR *, CC_FacilityInd_t *);
