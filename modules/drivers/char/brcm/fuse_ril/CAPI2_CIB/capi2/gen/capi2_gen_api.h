...
/**
	...
	@param		short_name (in) Param is short_name
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_MS_GetPLMNEntryByIndex_Rsp_t
**/
...
/**
	...
	@param		country_name (in) Param is country_name
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_MS_GetPLMNByCode_Rsp_t
**/
...
/**
	...
	@param		netReqSent (in) Param is netReqSent
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_NetRegApi_PlmnSelect_Rsp_t
**/
...
/**
	...
	@param		short_name (in)  Pointer to the buffer to store the PLMN short name
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_NetRegApi_GetPLMNNameByCode_Rsp_t
**/
...
/**
	...
	@param		RxQual (in)  rxquality passed by reference to be filled in by the called function
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PhoneCtrlApi_GetRxSignalInfo_Rsp_t
**/
...
/**
	...
	@param		sms_param_rec_no (in) Param is sms_param_rec_no
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SimApi_GetSmsParamRecNum_Rsp_t
**/
...
/**
	...
	@param		home_plmn (in)  Pointer to the returned HPLMN data.
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SimApi_GetHomePlmn_Rsp_t
**/
...
/**
	...
	@param		atr_data (in)  Buffer to store the returned ATR data
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SimApi_GetAtrData_Rsp_t
**/
...
/**
	...
	@param		rec_no (in)  0-based Record number
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SimApi_GetSmsSca_Rsp_t
**/
...
/**
	...
	@param		icc_parm (in) Param is icc_parm
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SimApi_GetIccid_Rsp_t
**/
...
/**
	...
	@param		sim_file_exist (in) Param is sim_file_exist
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SimApi_GetCallForwardUnconditionalFlag_Rsp_t
**/
...
/**
	...
	@param		pOutAidData (in)  Pointer to AID data buffer
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_USimApi_IsApplicationSupported_Rsp_t
**/
...
/**
	...
	@param		apn_name (in)  Buffer to store the returned APN name whose labels are separated by '.'
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_USimApi_GetAPNEntry_Rsp_t
**/
...
/**
	...
	@param		length (in)  Pointer to length
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SmsApi_RetrieveMaxCBChnlLength_Rsp_t
**/
...
//***************************************************************************************
/**
	Function to SYS_EnableCellInfoMsg
	@param		inClientInfoPtr (in) Client Information Pointer.
...
/**
	...
	@param		gprsContextID (in) Param is gprsContextID
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_IsGprsDialStr_Rsp_t
**/
...
/**
	...
	@param		phNum (in) Param is phNum
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetCallNumber_Rsp_t
**/
...
/**
	...
	@param		callingInfoPtr (in) Param is callingInfoPtr
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetCallingInfo_Rsp_t
**/
...
/**
	...
	@param		listSz (in) Param is listSz
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetAllCallStates_Rsp_t
**/
...
/**
	...
	@param		listSz (in)  returned list size
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetAllCallIndex_Rsp_t
**/
...
/**
	...
	@param		listSz (in) Param is listSz
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetAllHeldCallIndex_Rsp_t
**/
...
/**
	...
	@param		listSz (in) Param is listSz
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetAllActiveCallIndex_Rsp_t
**/
...
/**
	...
	@param		listSz (in) Param is listSz
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetAllMPTYCallIndex_Rsp_t
**/
...
/**
	...
	@param		inPresentPtr (in) Param is inPresentPtr
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetCallPresent_Rsp_t
**/
...
/**
	...
	@param		inCcCallState (in) Param is inCcCallState
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetCallIndexInThisState_Rsp_t
**/
...
/**
	...
	@param		callIndex (in) Index of call
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetCallClientInfo_Rsp_t
**/
...
/**
	...
	@param		ccm (in)  pointer to the returned call meter value.
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetCCM_Rsp_t
**/
...
/**
	...
	@param		ti (in) Param is ti
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetTiFromCallIndex_Rsp_t
**/
...
/**
	...
	@param		outBcPtr (in)  This contains all the parameters related to the <br>bearercapability to be retreived the bearer capability and repeat <br>indicator will be copied to the location pointed to in the structure <br>inBcPtr.
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetBearerCapability_Rsp_t
**/
...
/**
	...
	@param		rec_no (in)  Record Number
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SmsApi_GetSMSrvCenterNumber_Rsp_t
**/
...
/**
	...
	@param		flag (in)  Flag
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SmsApi_GetSIMSMSCapacityExceededFlag_Rsp_t
**/
...
/**
	...
	@param		status (in)  Status
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SmsApi_GetSmsStoredState_Rsp_t
**/
...
/**
	...
	@param		params (in)  Transmit Params
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SmsApi_GetSmsTxParams_Rsp_t
**/
...
/**
	...
	@param		smsParms (in)  Transmit Params
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SmsApi_GetTxParamInTextMode_Rsp_t
**/
...
/**
	...
	@param		NbUsed (in)  NbUsed - Number of Used slots in a given storageType
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SmsApi_GetSMSStorageStatus_Rsp_t
**/
...
/**
	...
	@param		mids (in)  Pointer to Cell Broadcast Message IDsChannels
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SmsApi_GetCBMI_Rsp_t
**/
...
/**
	...
	@param		langs (in)  Pointer to Cell Broadcast Language
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SmsApi_GetCbLanguage_Rsp_t
**/
...
/**
	...
	@param		vmInd (in)  Pointer to Voice Mail Indication
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SmsApi_GetVMWaitingStatus_Rsp_t
**/
...
/**
	...
	@param		num (in)  Number
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SmsApi_GetNumOfVmscNumber_Rsp_t
**/
...
/**
	...
	@param		vmsc (in)  Voice Mail Service Center Address
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SmsApi_GetVmscNumber_Rsp_t
**/
...
/**
	...
	@param		socket_id (in)  Socket ID for the SIM application.
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_ISimApi_IsIsimActivated_Rsp_t
**/
...
/**
	...
	@param		alpha (in)  pointer to alpha name
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PbkApi_GetAlpha_Rsp_t
**/
...
/**
	...
	@param		mean (in)  mean
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetGPRSQoS_Rsp_t
**/
...
/**
	...
	@param		mean (in)  mean
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetGPRSMinQoS_Rsp_t
**/
...
/**
	...
	@param		outCidActivate (in)  array of CID and Activate State
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetGPRSActivateStatus_Rsp_t
**/
...
/**
	...
	@param		pUMTSTft (in)  packet filter
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetUMTSTft_Rsp_t
**/
...
/**
	...
	@param		pR99Qos (in)  R99 QoS
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetR99UMTSMinQoS_Rsp_t
**/
...
/**
	...
	@param		pR99Qos (in)  R99 QoS
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetR99UMTSQoS_Rsp_t
**/
...
/**
	...
	@param		pDstQos (in)  UMTS QoS
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetUMTSMinQoS_Rsp_t
**/
...
/**
	...
	@param		pDstQos (in)  UMTS QoS
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetUMTSQoS_Rsp_t
**/
...
/**
	...
	@param		pR99Qos (in)  R99 QoS
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetNegQoS_Rsp_t
**/
...
/**
	...
	@param		pParms (in)  negotiated parameters qos
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetNegotiatedParms_Rsp_t
**/
...
/**
	...
	@param		pdpAddr (in)  PDP address
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetPDPAddress_Rsp_t
**/
...
/**
	...
	@param		outParam (in)  decoded protocol config options.
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PchExApi_GetDecodedProtConfig_Rsp_t
**/
...
/**
	...
	@param		authType (in)  authentication type
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PchExApi_BuildIpConfigOptions_Rsp_t
**/
...
/**
	...
	@param		po (in)  pap configure option
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PchExApi_BuildIpConfigOptions2_Rsp_t
**/
...
/**
	...
	@param		params (in)  chap authentication type parameters
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PchExApi_BuildIpConfigOptionsWithChapAuthType_Rsp_t
**/
...
/**
	...
	@param		pQos (in)  pointer to default Qos
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetDefaultQos_Rsp_t
**/
...
/**
	...
	@param		cidList (in) Param is cidList
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetDefinedPDPContextCidList_Rsp_t
**/
...
/**
	...
	@param		BootLoaderVersion_sz (in) Param is BootLoaderVersion_sz
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SYS_GetBootLoaderVersion_Rsp_t
**/
...
/**
	...
	@param		DSFVersion_sz (in) Param is DSFVersion_sz
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_SYS_GetDSFVersion_Rsp_t
**/
...
/**
	...
	@param		outUstPtr (in)  pointer to EF-UST data buffer
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_USimApi_GetUstData_Rsp_t
**/
...
/**
	...
	@param		number (in) Param is number
	 ...
	 Responses 
	 MsgType_t : ::MSG_SS_CALL_FORWARD_RSP
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : NetworkCause_t
**/
...
/**
	...
	@param		password (in) Param is password
	 ...
	 Responses 
	 MsgType_t : ::MSG_SS_CALL_BARRING_RSP
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : NetworkCause_t
**/
...
/**
	...
	@param		svcCls (in) Param is svcCls
	 ...
	 Responses 
	 MsgType_t : ::MSG_SS_CALL_WAITING_RSP
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : NetworkCause_t
**/
...
/**
	...
	@param		outPosEst (in)  The decoded location estimate result.
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_LCS_DecodePosEstimate_Rsp_t
**/
...
/**
	...
	@param		outAssistData (in)  The encoded assistance data.
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_LCS_EncodeAssistanceReq_Rsp_t
**/
...
/**
	...
	@param		pDefaultContext (in)  Default PDP context
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetPDPContextEx_Rsp_t
**/
...
/**
	...
	@param		outElementPtr (in)  pointer to the element which shall be updated
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_CcApi_GetElement_Rsp_t
**/
...
/**
	...
	@param		outProtConfigPtr (in)  The retrieved Protocol Config Options.
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_PdpApi_GetProtConfigOptions_Rsp_t
**/
...
/**
	...
	@param		outCapMaskPtr (in)  Bit mask indicates the supported GPS capabilities.
	 ...
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : CAPI2_LcsApi_GetGpsCapabilities_Rsp_t
**/
...
/**	Function to set time zone update mode
	...
	@param		mode (in)  Tz mode
	 ...
	 Responses 
	 MsgType_t : ::MSG_TIMEZONE_SET_UPDATE_MODE_RSP
	 Result_t :		::RESULT_OK or RESULT_ERROR
	 ResultData : N/A
**/
...
/**
	...
	@param		inClientInfoPtr (in) Client Information Pointer.
	 ...
	 Responses 
	 MsgType_t : ::MSG_TIMEZONE_GET_UPDATE_MODE_RSP
	 Result_t :		::RESULT_OK or RESULT_ERROR
...
//***************************************************************************************
/**
	This API is obsolete and should not be used  instead use NetRegApi_SetSupportedRatandBand
	@param		tid (in) Unique exchange/transaction id which is passed back in the response
	@param		clientID (in) Client ID
