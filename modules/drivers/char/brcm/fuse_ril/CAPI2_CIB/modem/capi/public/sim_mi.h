...
typedef struct
{
	...
	SIMSupport_t        sim_support;    // Whether SIM supports GSM only, RUIM only or dual-mode (both GSM and RUIM). This is applicable only for 2G SIM.
...
//***************************************************************************************
/**
	This function updates the "SMS Capacity Exceeded" flag in EF-SMSS and posts the 
	"SMS Capacity Exceeded" status to SMS module if we need to do so.
**/
