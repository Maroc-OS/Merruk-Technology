...
//============================================================================
//
// Function Name: chal_audiovopath_EnableSuppressionShuffling
//
// Description:   enable Fs/2 suppression AND shuffler
//      Athena B1 Headset Line Driver THDN meets spec, when Fs/2 suppression
//      is enabled (CCR_TONE = 1), and shuffler enabled (CCR_DIS = 0)
//
//		at*mdsptst=202, 0x30800f5c, 0x0004
//
//============================================================================
cVoid chal_audiovopath_EnableSuppressionShuffling ( CHAL_HANDLE handle )
{
	BRCM_WRITE_REG_FIELD(sVOPath.base, DSP_AUDIO_AIR_R, CCR_TONE, 1);
	//BRCM_WRITE_REG_FIELD(sVOPath.base, DSP_AUDIO_AIR_R, CCR_DIS, 0);
}
